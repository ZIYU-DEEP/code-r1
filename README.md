...
(main_task pid=2582740) Unhandled error (suppress with 'RAY_IGNORE_UNHANDLED_ERRORS=1'): ray::WorkerDict.actor_rollout_load_checkpoint() (pid=2584161, ip=10.138.0.2, actor_id=154f065ced2b3baea205d20f01000000, repr=<verl.single_controller.ray.base.WorkerDict object at 0x7ed61db564a0>)
(main_task pid=2582740)   File "/home/hazelye_google_com/github/code-r1/verl/single_controller/ray/base.py", line 399, in func
(main_task pid=2582740)     return getattr(self.worker_dict[key], name)(*args, **kwargs)
(main_task pid=2582740)   File "/home/hazelye_google_com/github/code-r1/verl/single_controller/base/decorator.py", line 404, in inner
(main_task pid=2582740)     return func(*args, **kwargs)
(main_task pid=2582740)   File "/home/hazelye_google_com/github/code-r1/verl/workers/fsdp_workers.py", line 585, in load_checkpoint
(main_task pid=2582740)     self.checkpoint_manager.load_checkpoint(path=path, del_local_after_load=del_local_after_load)
(main_task pid=2582740)   File "/home/hazelye_google_com/github/code-r1/verl/utils/checkpoint/fsdp_checkpoint_manager.py", line 78, in load_checkpoint
(main_task pid=2582740)     extra_state_dict = torch.load(local_extra_state_path)
(main_task pid=2582740)   File "/opt/conda/envs/code/lib/python3.10/site-packages/torch/serialization.py", line 1470, in load
(main_task pid=2582740)     raise pickle.UnpicklingError(_get_wo_message(str(e))) from None
(main_task pid=2582740) _pickle.UnpicklingError: Weights only load failed. This file can still be loaded, to do so you have two options, do those steps only if you trust the source of the checkpoint.
(main_task pid=2582740)  (1) In PyTorch 2.6, we changed the default value of the `weights_only` argument in `torch.load` from `False` to `True`. Re-running `torch.load` with `weights_only` set to `False` will likely succeed, but it can result in arbitrary code execution. Do it only if you got the file from a trusted source.
(main_task pid=2582740)  (2) Alternatively, to load with `weights_only=True` please check the recommended steps in the following error message.
(main_task pid=2582740)  WeightsUnpickler error: Unsupported global: GLOBAL numpy.core.multiarray._reconstruct was not an allowed global by default. Please use `torch.serialization.add_safe_globals([_reconstruct])` or the `torch.serialization.safe_globals([_reconstruct])` context manager to allowlist this global if you trust this class/function.
(main_task pid=2582740)
(main_task pid=2582740) Check the documentation of torch.load to learn more about types accepted by default with weights_only https://pytorch.org/docs/stable/generated/torch.load.html.
Traceback (most recent call last):
  File "/home/hazelye_google_com/github/code-r1/verl/trainer/main_ppo.py", line 25, in main
    run_ppo(config)
  ...
  File "/opt/conda/envs/code/lib/python3.10/site-packages/ray/_private/worker.py", line 919, in get_objects
    raise value.as_instanceof_cause()
ray.exceptions.RayTaskError(UnpicklingError): ray::main_task() (pid=2582740, ip=10.138.0.2)
  File "/home/hazelye_google_com/github/code-r1/verl/trainer/main_ppo.py", line 128, in main_task
    trainer.fit()
  File "/home/hazelye_google_com/github/code-r1/verl/trainer/ppo/ray_trainer.py", line 879, in fit
    self._load_checkpoint()
  File "/home/hazelye_google_com/github/code-r1/verl/trainer/ppo/ray_trainer.py", line 829, in _load_checkpoint
    self.actor_rollout_wg.load_checkpoint(actor_path,
  File "/home/hazelye_google_com/github/code-r1/verl/single_controller/ray/base.py", line 42, in func
    output = ray.get(output)
ray.exceptions.RayTaskError(UnpicklingError): ray::WorkerDict.actor_rollout_load_checkpoint() (pid=2584166, ip=10.138.0.2, actor_id=4545482f3305b10866cb303a01000000, repr=<verl.single_controller.ray.base.WorkerDict object at 0x7f5fb9e964a0>)
  File "/home/hazelye_google_com/github/code-r1/verl/single_controller/ray/base.py", line 399, in func
    return getattr(self.worker_dict[key], name)(*args, **kwargs)
  File "/home/hazelye_google_com/github/code-r1/verl/single_controller/base/decorator.py", line 404, in inner
    return func(*args, **kwargs)
  File "/home/hazelye_google_com/github/code-r1/verl/workers/fsdp_workers.py", line 585, in load_checkpoint
    self.checkpoint_manager.load_checkpoint(path=path, del_local_after_load=del_local_after_load)
  File "/home/hazelye_google_com/github/code-r1/verl/utils/checkpoint/fsdp_checkpoint_manager.py", line 78, in load_checkpoint
    extra_state_dict = torch.load(local_extra_state_path)
  File "/opt/conda/envs/code/lib/python3.10/site-packages/torch/serialization.py", line 1470, in load
...
Set the environment variable HYDRA_FULL_ERROR=1 for a complete stack trace.
(WorkerDict pid=2584161) INFO 04-23 22:50:23 [worker.py:133] Sleep mode freed 33.06 GiB memory, 7.90 GiB memory is still in use. [repeated 7x across cluster]
(WorkerDict pid=2584161) INFO 04-23 22:50:23 [executor_base.py:208] It took 6.070367 seconds to fall asleep. [repeated 7x across cluster]
(WorkerDict pid=2584161) kwargs: {'n': 16, 'logprobs': 0, 'max_tokens': 4096, 'detokenize': False, 'temperature': 1.0, 'top_k': -1, 'top_p': 1, 'ignore_eos': False} [repeated 7x across cluster]
(WorkerDict pid=2584160) [rank-1]: Loading from /home/hazelye_google_com/github/code-r1/./models/code-r1-12k-leetcode2k-taco-grpo/global_step_128/actor/model_world_size_8_rank_1.pt and /home/hazelye_google_com/github/code-r1/./models/code-r1-12k-leetcode2k-taco-grpo/global_step_128/actor/optim_world_size_8_rank_1.pt and /home/hazelye_google_com/github/code-r1/./models/code-r1-12k-leetcode2k-taco-grpo/global_step_128/actor/extra_state_world_size_8_rank_1.pt [repeated 7x across cluster]
```
